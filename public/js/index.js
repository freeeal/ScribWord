...
const copy_info = document.getElementById('copy_info');
const info = document.getElementById('info');
const save_transcript_button = document.getElementById('save_transcript_button');
const conversation_info = document.getElementById('conversation_info');
...
function createConversation() {
  ...
  // make a POST request to topic modeling route in api
  axios.post('/analyze', newConversation)
...
function saveTranscript() {
  ...
  save_transcript_button.style.display = 'none';
  conversation_info.style.display = 'inline-block';
  showInfo('');
}
